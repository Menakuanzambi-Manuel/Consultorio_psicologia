        ...
        <>
            <section id="contact" className="block contact-block mt-5">
                <Container fluid>
                    ...
                    <Row>
                        <Col sm={6}>
                            <h2 className="">Tem algum projecto que precisa sair do papel?
                                Podemos ajudar, basta nos enviar uma mensagem.</h2>
                            ...
                            <Form className='contact-form'>
                                ...
                                <Row>
                                    <Col sm={6}>
                                        <Form.Control type="text" placeholder='Seu endereço de email' required />
                                    </Col>
                                    <Col sm={6}>
                                        <Form.Control type="text" placeholder='Seu endereço de email' required />
                                    </Col>
                                ...
                                <p>Ao enviar esta mensagem estás ciente de que leu e concorda com <br /> 
                                a nossa politica de dados, bem como os nossos termos de serviços. </p>
